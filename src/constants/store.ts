export const SET_CATEGORIES = "games/set_categories";
export const SET_SELECTED_GAME = "games/set_selected_game";
export const SET_RECOMMENDED = "games/set_recommended";
export const SET_POPULAR = "games/set_popular";
export const SET_FEATURED_GAME = "games/set_featured_game";

export const MUTATE_CATEGORIES = "games/mutate_categories";
export const MUTATE_SELECTED_GAME = "games/mutate_selected_game";
